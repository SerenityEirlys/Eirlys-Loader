...
let wallpapers = ["thum.webm", "Retrorem2.webm"]
let bg_filters = {
	"rcp-fe-lol-champ-select": {"thum.webm": 'blur(3px) brightness(0.4) saturate(1.5)',
								"Retrorem2.webm": 'blur(3px) brightness(0.4) saturate(1.5)'},
	"rcp-fe-lol-clash-full": {"thum.webm": 'blur(10px) brightness(0.2)',
							  "Retrorem2.webm": 'blur(10px) brightness(0.2)'},
	"rcp-fe-lol-loot": {"thum.webm": 'brightness(0.3)',
						"Retrorem2.webm": 'brightness(0.3)'},
	"rcp-fe-lol-store": {"thum.webm": 'brightness(0.2)',
						 "Retrorem2.webm": 'brightness(0.45) saturate(0.5) blur(5px)'},
	"rcp-fe-lol-collections": {"thum.webm": 'brightness(0.2)',
							   "Retrorem2.webm": 'brightness(0.2)'},
	"rcp-fe-lol-profiles-main": {"thum.webm": 'brightness(0.3)',
								 "Retrorem2.webm": 'brightness(0.3)'},
	"rcp-fe-lol-parties": {"thum.webm": 'brightness(0.4) blur(6px)',
						   "Retrorem2.webm": 'brightness(0.4) blur(6px)'},
	"default": {"thum.webm": 'brightness(0.7) saturate(0.8)',
				"Retrorem2.webm": 'none'},
}
...
window.addEventListener('load', () => {
	...
	utils.addCss("//plugins/rem_theme/assets/arisu.css")
